  ...
  <div>
    ...
    <v-container>
      ...
      <div>
        ...
        <v-row>
          <v-card target="_blank" outlined class="ma-2 pa-4 text-center" style="font-size: 18px; width: 200px" href="/player/THUAI_v1.4_Windows.zip">
            <div>
              <v-icon large>mdi-microsoft-windows</v-icon>
            </div>
            Windows版
          </v-card>
          <v-card target="_blank" outlined class="ma-2 pa-4 text-center" style="font-size: 18px; width: 200px" href="/player/THUAI_v1.4_MacOSX.zip">
            <div>
